    ...
    try {
        ...
        notas.forEach(nota => {
            ...
            tarjeta.innerHTML = `
                ...
                <div>
                    <div class="acciones">
                        <button class="btn-editar" onclick="prepararEdicion(${nota.id}, '${nota.nombre}', '${nota.mensaje}')">✏️ Editar</button>
                        <button class="btn-eliminar" onclick="eliminarNota(${nota.id})">🗑️ Borrar</button>
                    </div>
...
function prepararEdicion(id, nombre, mensaje) {
    ...
    tituloFormulario.innerText = "✏️ Editando Nota";
